...
def fuse_reads(summary, paf, distance, top_N, alt, debug):
    ...
    :param summary: sequencing_summary.txt file
    :param paf: mapping.paf file
    :param distance: (int) max distance between two read mappings
    :param top_N: (int) how many 'top' reads to display
    :param alt: (bool) allow alternate assemblies
    :param debug: (bool) write debug file
    :return: fused_reads_df, sequencing_summary_df, read_ids of just fused reads
    """
    ...
    stats_n50['Original:'] = n50(ss['sequence_length_template'])
    ...
    stats_n50['Un-fused reads:'] = n50(un_fused_df['sequence_length_template'])
    stats_n50['To be fused:'] = n50(split_df['sequence_length_template'])
    stats_n50['Fused read:'] = n50(df2['combined_length'])
    stats_n50['New:'] = n50(new_n50)
